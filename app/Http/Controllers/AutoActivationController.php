...
class AutoActivationController extends Controller
{
    public function bot_activation()
    {
        ...
        DB::insert('INSERT INTO `user_programs` (`id`, `user_id`, `list`, `inviter_list`, `status_id`, `program_id`, `package_id`, `created_at`, `updated_at`) VALUES (NULL, \'1\', \',\', \'\', \'1\', \'1\', \'4\', \'2020-03-11 00:00:00\', \'2020-03-11 00:00:00\');');
