                    ...
                    <div class="card card-block">
                        <div class="row">
                            ...
                            <div class="col-md-8 col-lg-9">
                                <h3 class="box-title m-b-0">{{ $current_user->name }}</h3> <small>{{ \App\Models\Status::find($current_user->status_id)->title }}</small>
                                <address>
                        ...
                        @if(!is_null($left_user))
                            <a href="/tree/{{ $left_user->user_id }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <h3 class="box-title m-b-0">{{ $left_user->name }}</h3> <small>{{ \App\Models\Status::find($left_user->status_id)->title }}</small>
                                        <address>
                        ...
                        @if(!is_null($right_user))
                            <a href="/tree/{{ $right_user->user_id }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <h3 class="box-title m-b-0">{{ $right_user->name }}</h3> <small>{{ \App\Models\Status::find($right_user->status_id)->title }}</small>
                                        <address>
                        ...
                        @if(!is_null($left_user_l))
                            <a href="/tree/{{ $left_user_l->user_id }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <h3 class="box-title m-b-0">{{ $left_user_l->name }}</h3> <small>{{ \App\Models\Status::find($left_user_l->status_id)->title }}</small>
                                        <address>
                        ...
                        @if(!is_null($left_user_r))
                            <a href="/tree/{{ $left_user_r->user_id }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <h3 class="box-title m-b-0">{{ $left_user_r->name }}</h3> <small>{{ \App\Models\Status::find($left_user_r->status_id)->title }}</small>
                                        <address>
                        ...
                        @if(!is_null($right_user_l))
                            <a href="/tree/{{ $right_user_l->user_id }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <h3 class="box-title m-b-0">{{ $right_user_l->name }}</h3> <small>{{ \App\Models\Status::find($right_user_l->status_id)->title }}</small>
                                        <address>
                        ...
                        @if(!is_null($right_user_r))
                            <a href="/tree/{{ $right_user_r->user_id }}">
                                <div class="row">
                                    ...
                                    <div class="col-md-8 col-lg-9">
                                        <h3 class="box-title m-b-0">{{ $right_user_r->name }}</h3> <small>{{ \App\Models\Status::find($right_user_r->status_id)->title }}</small>
                                        <address>
