                                    ...
                                    <div class="table-responsive">
                                        <table class="table stylish-table">
                                            ...
                                            <tr>
                                                ...
                                                @if(!is_null($package))
                                                    <td><h5>2</h5></td>
                                                    <td><h5>${{ $package->cost + env('REGISTRATION_FEE') }}</h5></td>
                                                    <?php $all_cost = $package->cost + env('REGISTRATION_FEE'); ?>
                                                @else
                                                    <td><h5>1</h5></td>
                                                    <td><h5>${{ env('REGISTRATION_FEE') }}</h5></td>
                                                    <?php $all_cost = env('REGISTRATION_FEE'); ?>
                                                @endif
                                            </tr>
                                            </tbody>
                                        </table>
